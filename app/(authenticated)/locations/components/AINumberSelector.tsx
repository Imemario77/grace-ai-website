...
interface AINumberSelectorProps {
  currentNumber: string
  onNumberSelected: (number: string) => void
}

export function AINumberSelector({ currentNumber, onNumberSelected }: AINumberSelectorProps) {
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      setAvailableNumbers([`+1 (${areaCode}) 555-0123`, `+1 (${areaCode}) 555-0124`, `+1 (${areaCode}) 555-0125`])
